...
(function () {
  ...
  const PROJECTS = {
     TeamPL: {
          ...
          cat: '제 3회 "Let's Go!" COSS 스타트업 경진대회', // 🔧 제목 위나 옆에 달리는 카테고리 태그입니다
          year: '2026', // 🔧 연도 태그
    ...
    CITY: {
      ...
      media: [
        ...
        { type: 'img', src: 'img/CITY01.png', label: 'img' },
        // 🔧 PDF:   { type:'pdf',   src:'pdf/파일명.pdf', label:'설명' }
        { type: 'pdf', src: 'https://drive.google.com/file/d/129ZRGtbEiZpoyGmBRwL1f1cdBHogAoSr/view?usp=sharing', label: 'pdf' },
        // 🔧 영상:  { type:'video', src:'video/파일명.mp4', label:'설명' }
        { type: 'video', src: 'https://drive.google.com/file/d/165wWmOvIh6XDsoWgs2Cz4bZukWXie9S_/view?usp=sharing', label: 'video' },
      ]
    },
    Jeonger: {
      title: 'Jeonger',
