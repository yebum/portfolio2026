...
(function () {
  ...
  function buildProjectPageHTML(data, isDark) {
    ...
    const scrollSectionsHTML = sections.map((sec, i) => {
      ...
      <p class="ss-body">${formatReadableText(sec.body)}</p>
    </div>`;
...
<div class="proj-hero ss-reveal">
  ...
  <div class="hero-desc">
    <p>${formatReadableText(data.desc1)}</p>
    ${data.desc2 ? `<p>${formatReadableText(data.desc2)}</p>` : ''}
  </div>
</div>
